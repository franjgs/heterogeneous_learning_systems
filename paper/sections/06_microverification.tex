\section{Results: limited microverification}

The only results reported in this draft are numerical consistency checks designed to falsify implementation or algebraic errors in the stated minimal model. They are \emph{not} empirical validation of the HLS programme or its architecture.
