...
Routing/allocation can be used as the source of task-dependent experience entering a
competence transition.
& Transferred/synthesized
& Compatible composition of the above mechanisms.\\[2mm]

\((F_t,S_t)\to a_t\to x_t\to S_{t+1}\to a_{t+1}\).
& HLS synthesis
& Not stated as such by any single cited source.\\[2mm]

A particular machine-learning implementation of \(S_t,\mathcal R,\mathcal X,\mathcal L\).
& Open
...
The combined skeleton should therefore be described as \emph{theoretically grounded}, not as
an established theorem inherited from the literature.
