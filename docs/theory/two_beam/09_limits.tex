...
determines operational allocation, allocation determines real work, and work may generate
learning exposure that modifies the competence state on which future organization depends.
The individual mechanisms are grounded in established theories, while their composition and
source-to-HLS mappings remain a candidate scaffold.
\end{quote}

This is the appropriate stopping point before defining common operational value and strong
joint/separate policy classes. Garicano and Gutjahr remain primary current references rather
than definitions of the two beams.
