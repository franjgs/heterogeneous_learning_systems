...
\subsection{Primary current reference}

One primary current formal reference is \citet{garicano2000}. Garicano studies production in which
...
Beam~1 is not identical to this source model. It requires additional independent theoretical
lines that may corroborate, generalize, restrict, complement, or contradict Garicano's
results. No final set of those lines is asserted in this note.
