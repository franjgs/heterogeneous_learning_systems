...
The present question is narrower than the full Heterogeneous Learning Systems (HLS)
programme. We ask only whether the following two theoretical components have defensible
source foundations and can be connected through explicitly typed mappings.
...
They are governed by the canonical HLS ontology. Garicano and Gutjahr are primary current
references for the respective beams, not complete theories of those beams.
